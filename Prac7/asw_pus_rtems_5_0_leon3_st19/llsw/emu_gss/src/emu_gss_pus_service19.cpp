...
// Parte de padre para que haya params y métodos genéricos comunes a todos los TC
	mEvID = evID;
	NewProgram(this); //La herencia te permite tratarlo como si fuera padre
}
...
EmuGSS_TCProgram19_5::EmuGSS_TCProgram19_5(uint32_t uniTime2YK,
	...
	//TODO DONE Get attributes from Constructor Parameters and
...
void EmuGSS_TCProgram19_5::BuildTCAppData(tc_mem_descriptor_t &tc_descriptor) {
	...
	//TODO DONE Set TC App Data Using SetNextXXXX As EmuGSS_TCProgram19_4
